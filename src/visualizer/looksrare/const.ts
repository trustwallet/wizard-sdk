...
export const strategiesLookup = {
  // Standard fixed price sales
  [mainnetAddresses.STRATEGY_STANDARD_SALE.toLocaleLowerCase()]:
    STRATEGY.FIXED_PRICE_STANDARD,
  [goerliAddresses.STRATEGY_STANDARD_SALE.toLocaleLowerCase()]:
    STRATEGY.FIXED_PRICE_STANDARD,

  // Any token from collection sales
  [mainnetAddresses.STRATEGY_COLLECTION_SALE.toLocaleLowerCase()]:
    STRATEGY.FIXED_PRICE_COLLECTION,
  [goerliAddresses.STRATEGY_COLLECTION_SALE.toLocaleLowerCase()]:
    STRATEGY.FIXED_PRICE_COLLECTION,

  // Dutch Auction sales
  [mainnetAddresses.STRATEGY_DUTCH_AUCTION.toLocaleLowerCase()]: STRATEGY.AUCTION_DUTCH,
  [goerliAddresses.STRATEGY_DUTCH_AUCTION.toLocaleLowerCase()]: STRATEGY.AUCTION_DUTCH,

  // Private sales
  [mainnetAddresses.STRATEGY_PRIVATE_SALE.toLocaleLowerCase()]:
    STRATEGY.FIXED_PRICE_PRIVATE,
  [goerliAddresses.STRATEGY_PRIVATE_SALE.toLocaleLowerCase()]:
    STRATEGY.FIXED_PRICE_PRIVATE,
};
